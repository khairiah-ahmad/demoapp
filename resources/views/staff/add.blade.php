  ...
  <br>
    <div class="row justify-content-center">
        ...
        <div class="col-md-6">
                ...
                <a href="{{ route('staff.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Reset</a>
        </div>
        </div>
        <div class="row">
            <div class="col-md-6">
      ...
      <form action="{{ route('staff.store') }}" method="POST">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-4">
                <input id="mobile_no" type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" placeholder="Mobile Phone No. (eg. 0123456789)" value="{{ old('mobile_no') }}" >
                <!--
            ...
            <div class="col-md-4">
                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror" name="tel" placeholder="Office Phone No. (eg. 0378900000)" value="{{ old('tel') }}" >
                <!--
                @if($errors->has('tel'))
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-md-8">
                <textarea name="office_addr" class="form-control" id="office_addr" rows="5">{{ old('office_addr') }}</textarea>
            </div>
        </div>
